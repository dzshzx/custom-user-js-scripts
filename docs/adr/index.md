...
| [ADR-0002](./0002-green-pull-requests-are-the-release-gate.md) | accepted (2026-08-17; amended 2026-09-14) | 完整版本计划校验 → 候选分支 CI 绿 → promote 按最新基线复验后快进 master 即发布；仅精确下一 patch 自动，已发布版本不可变 |
