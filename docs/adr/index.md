...
| [ADR-0002](./0002-green-pull-requests-are-the-release-gate.md) | accepted (2026-08-17; amended 2026-09-08) | 候选分支 bump `@version` → `candidate/**` CI 绿 → promote 快进 master 即发布（2026-09-08 起不再走 PR）；已发布版本不可变 |
...
- 打包与发布：ADR-0001（dist + 桥接）→ ADR-0002（candidate/promote 门 = 发布边界）。
