...
function createWidgetElement({ documentObject, model }) {
  ...
  // The countdown text updates every second, so it is aria-hidden; a separate
  // visually-hidden status node announces only lifecycle changes
  // (enabled/paused/resumed/disabled) with a full sentence.
