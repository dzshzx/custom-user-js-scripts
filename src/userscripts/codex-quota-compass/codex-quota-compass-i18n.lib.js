(function attachCodexQuotaCompassI18nLib(globalObject) {
  ...
  const messages = {
    'zh-CN': {
      ...
      sectionCostLedger: '消耗成本（已结算）',
      costCycleLabel: '本周期',
      costMonthLabel: '本月',
      costTodayLabel: '今日（暂估）',
      costSettledDaily: '每日已结算',
      costCycleNote: '按 UTC 整日累计；周期起始当日按整日计入（近似）。前一天约次日 08:00（UTC 日结束）后定稿。',
    ...
    en: {
      ...
      sectionCostLedger: 'Cost (settled)',
      costCycleLabel: 'This cycle',
      costMonthLabel: 'This month',
      costTodayLabel: 'Today (estimate)',
      costSettledDaily: 'Settled daily',
      costCycleNote: 'Sums whole UTC days; the cycle start day counts in full (approx). A day finalizes after ~08:00 next day (UTC day end).',
