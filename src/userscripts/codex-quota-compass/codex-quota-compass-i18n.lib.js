(function attachCodexQuotaCompassI18nLib(globalObject) {
  ...
  const messages = {
    'zh-CN': {
      ...
      remoteSyncConfigureAction: '配置 Gist 同步',
      remoteSyncNowAction: '立即同步',
      remoteSyncDisableAction: '停用 Gist 同步',
      ...
      menuExport: '导出用量记录',
      menuImport: '导入用量记录',
      remoteSyncTokenPrompt: 'GitHub token。建议使用 fine-grained token，并授予 Gists read/write 权限。',
      remoteSyncTokenKeepPrompt: 'GitHub token。留空则保留当前 token。',
      remoteSyncGistIdPrompt: 'Gist ID。首次配置可留空，脚本会自动查找或创建。',
      remoteSyncTokenRequired: '需要 GitHub token 才能启用 Gist 同步。',
      remoteSyncConfigSaved: 'Gist 同步配置已保存。',
      remoteSyncDone: 'Gist 同步完成：本地新增 {added} 条，云端归档已更新。',
      remoteSyncSkipped: 'Gist 同步未执行：{status}',
      remoteSyncDisableConfirm: '停用 Codex 用量 Gist 同步？本地记录不会删除。',
      remoteSyncDisabled: 'Gist 同步已停用。',
    ...
    en: {
      ...
      remoteSyncConfigureAction: 'Configure Gist Sync',
      remoteSyncNowAction: 'Sync Now',
      remoteSyncDisableAction: 'Disable Gist Sync',
      ...
      remoteSyncTokenPrompt: 'GitHub token. Use a fine-grained token with Gists read/write permission.',
      remoteSyncTokenKeepPrompt: 'GitHub token. Leave empty to keep the current token.',
      remoteSyncGistIdPrompt: 'Gist ID. Leave empty on first setup; the script will find or create one.',
      remoteSyncTokenRequired: 'A GitHub token is required to enable Gist sync.',
      remoteSyncConfigSaved: 'Gist sync settings saved.',
      remoteSyncDone: 'Gist sync complete: {added} local added; cloud archive updated.',
      remoteSyncSkipped: 'Gist sync skipped: {status}',
      remoteSyncDisableConfirm: 'Disable Codex quota Gist sync? Local records will not be deleted.',
      remoteSyncDisabled: 'Gist sync disabled.',
